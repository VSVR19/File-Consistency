...
def client_details():
    try:
        ...
        rpcgui.entry.insert(tk.END, "Client 3 welcomes you! "+ "\n")
        rpcgui.entry.insert(tk.END, s.connected_clients(client_name) + "\n")
		#The clients name is transmitted to server here.
    
        while True:
            f = open("C:\\Users\\Venkat\\Desktop\\DS Assignment 2\\Client 3\\AS2_File.txt", "r")
            file_data = f.read()
            ...
            while True:
                ...
                f_sleep = open("C:\\Users\\Venkat\\Desktop\\DS Assignment 2\\Client 3\\AS2_File.txt", "r")
